            ...
            <ScrollView>
                ...
                <View>
                    ...
                    <View style={{ alignItems: "center" }}>
                        <TouchableOpacity style={{ height: 54, marginBottom: 16, flexDirection: "row", alignItems: "center", width: "95%", justifyContent: "space-between", padding: 10 }}>
                            <View style={{ justifyContent: "space-between", flexDirection: "row", alignItems: "center" }}>
                                <Image source={require('../../assets/images/ProfilePicNew.png')} style={{ width: 54, height: 54, resizeMode: "contain", marginRight: 5 }} />
                                <View>
                                    <Text style={{ fontSize: 14, lineHeight: 16.94, fontWeight: "500", color: "#0E0E0E" }}>Shorupan Pirakaspathy</Text>
                                    <Text style={{ color: '#B3B3B3', fontSize: 12, fontWeight: "500" }}>+91 64755901832c</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ height: 54, marginBottom: 16, flexDirection: "row", alignItems: "center", width: "95%", justifyContent: "space-between", padding: 10 }}>
