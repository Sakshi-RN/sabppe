...
export default function MetroAddCard() {
        ...
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            ...
            <View style={{ alignItems: "center" }}>
                <View style={{ borderRadius: 10, borderWidth: 1, borderColor: "#E7E7E7", width: 320, height: 56, justifyContent: "center", padding: 10, marginBottom: 20, marginTop: 30 }}>
                    <TextInput onChangeText={(text) => setServiceNum(text)} value={serviceNum} style={{ fontSize: 18, color: "#3D3D3D" }} placeholder='Enter Card Number' keyboardType='number-pad' />
                </View>
                <TouchableOpacity onPress={() => Navigation.navigate('MetroRechargePayment')} style={{ backgroundColor: "#07B5F9", width: '90%', height: 56, borderRadius: 10, alignItems: "center", justifyContent: "center" }}>
