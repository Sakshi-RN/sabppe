...
export default function MuncipalHouseNum() {
    ...
    const ContunueToPay = () => {
        if (serviceNum === '1234123412341234') {
            ...
            Navigation.navigate('MuncipalBill')
        }
    }
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <SubScreenHeader Name='Gram Panchayat' />
            ...
            <View style={{ alignItems: "center" }}>
                <View style={{ borderRadius: 10, borderWidth: 1, borderColor: "#E7E7E7", width: 320, height: 56, justifyContent: "center", padding: 10, marginBottom: 20, marginTop: 30 }}>
                    <TextInput onChangeText={(text) => setServiceNum(text)} value={serviceNum} style={{ fontSize: 18 }} placeholder='Enter House Number' keyboardType='number-pad' />
                </View>
