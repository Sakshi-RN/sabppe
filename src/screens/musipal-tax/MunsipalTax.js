...
export default function MunsipalTax() {
    const Navigation = useNavigation();
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <SubScreenHeader Name='Municipal Tax'/>
            ...
            <ScrollView>
                <View style={{ width: "100%", alignItems: "center", marginTop: 30 }}>
                    ...
                    <TouchableOpacity onPress={() => Navigation.navigate('MuncipalHouseNum')} style={{ height: 77, marginBottom: 16, flexDirection: "row", alignItems: "center", width: "95%", justifyContent: "space-between", borderColor: "#E5E1EF", borderRadius: 15, borderWidth: 1, padding: 10 }}>
